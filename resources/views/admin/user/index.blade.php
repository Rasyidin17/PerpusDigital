                ...
                <div class="flex-grow-1 card-p pb-0">
                    <div class="d-flex flex-stack flex-wrap">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Account">
                        </div>
                        <!--begin::Actions-->
                            ...
                            <tr>
                                ...
                                <td>   
                                    <form action="{{ route('users.destroy', $item->id) }}" method="POST">
                                        <a class="btn btn-info" href="{{ route('users.show',$item->id) }}">
                                        ...
                                        <a class="btn btn-primary" href="{{ route('users.edit',$item->id) }}">
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Yakin mau hapus {{ $item->nickname }}?')" class="btn btn-danger">
