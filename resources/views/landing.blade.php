				...
				<div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url({{ asset('source/html/theme/demo1/dist/assets/media/svg/illustrations/landing.svg') }})">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div class="d-flex align-items-center flex-equal">
									...
									<a href="../../demo1/dist/landing.html">
										<img alt="Logo" src="{{ asset('source/html/theme/demo1/dist/assets/media/avatars/logos.png') }}" class="logo-default h-50px h-lg-75px" />
										<img alt="Logo" src="{{ asset('source/html/theme/demo1/dist/assets/media/avatars/logos.png') }}" class="logo-sticky h-50px h-lg-75px" />
									</a>
									<!--end::Logo image-->
								</div>
								<!--end::Logo-->
								...
								<div class="d-lg-block" id="kt_header_nav_wrapper">
									<div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav_wrapper'}">
										...
										<div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-bold" id="kt_landing_menu">
											...
											<div class="menu-item">
												<!--begin::Menu link-->
												<a class="menu-link {{ request()->is('home*') ? 'active' : '' }}" href="{{route('home')}}" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Home</a>
												<!--end::Menu link-->
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											{{-- <div class="menu-item">
												<!--begin::Menu link-->
												<a class="menu-link nav-link py-3 px-4 px-xxl-6" href="{{ route('password.request') }}" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">How it Works</a>
												<!--end::Menu link-->
											</div> --}}
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item">
												<!--begin::Menu link-->
												<a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_1">Ganti Password Akun</a>
												<!--end::Menu link-->
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											...
											<div class="menu-item">
												<!--begin::Menu link-->
												<a class="menu-link nav-link py-3 px-4 px-xxl-6" href="{{ route('details.index') }}" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">My Book</a>
												<!--end::Menu link-->
											</div>
											<!--end::Menu item-->
										</div>
					...
					<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
						...
						<div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
							<!--begin::Title-->
							<h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15">Selamat Datang di Perpus Digital
							<br />
							<span style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
								<span id="kt_landing_hero_text">Budayakan Literasi!!</span>
							</span></h1>
							<!--end::Title-->
							<!--begin::Action-->
							<a href="{{ route('bks.index') }}" class="btn btn-primary">Cari Buku</a>
							<!--end::Action-->
						</div>
						<!--end::Heading-->
						<!--begin::Clients-->
					...
					<div class="container">
						...
						<div class="d-flex flex-center">
							...
							<div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
								<!--begin::Item-->
								<div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url({{ asset('source/html/theme/demo1/dist/assets/media/svg/misc/octagon.svg') }})">
									<!--begin::Symbol-->
			...
			<div class="py-10 py-lg-20">
				...
				<div class="container">
					...
					<div class="text-center mb-12">
						<!--begin::Title-->
						<h3 class="fs-2hx text-dark mb-5" id="team" data-kt-scroll-offset="{default: 100, lg: 150}">Buku yang Kami Rekomendasikan</h3>
						<!--end::Title-->
						<!--begin::Sub-title-->
						<div class="fs-5 text-muted fw-bold">Buku yang Kami Tampilkan Dibawah ini Berdasarkan Jumlah Baca
						<br />Baca Buku yang Kami Rekomendasikan Dibawah ini</div>
						<!--end::Sub-title=-->
					</div>
					<!--end::Heading-->
					<!--begin::Slider-->
						...
						<div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="5000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev" data-tns-next-button="#kt_team_slider_next" data-tns-responsive="{1200: {items: 3}, 992: {items: 2}}">
							...
							@foreach ($mostBorrowedBooks as $book)
								<div class="text-center">
									<!--begin::Photo-->
									<div class="mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url({{ asset('storage/images/'.$book->img) }})"></div>
									<!--end::Photo-->
									<!--begin::Person-->
									<div class="mb-0">
										<!--begin::Name-->
										<div class="text-dark text-muted fs-6 fw-bold mt-1">{{ $book->judul }}</div>
										<!--end::Name-->
										 <!--begin::Borrowed Count-->
										<div class="text-muted fs-6 mt-1">Dibaca Sebanyak {{ $book->currentBorrowedCount()  }} kali</div>
										<!--end::Borrowed Count-->
										<!--begin::Position-->
										<a href="{{ route('details.show', $book->id) }}" class="text-dark fw-bolder text-hover-primary fs-3">Lihat Buku</a>
										<!--begin::Position-->
									</div>
									<!--end::Person-->
								</div>
						...
						<div class="row py-10 py-lg-20">
							...
							<div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
								...
								<div class="rounded landing-dark-border p-9 mb-10">
									<!--begin::Title-->
									<h2 class="text-white">Apakah Anda Membutuhkan Bantuan?</h2>
									<!--end::Title-->
									<!--begin::Text-->
									<span class="fw-normal fs-4 text-gray-700">Silahkan Hubungi Email Ini
									<a href="#" class="text-white opacity-50 text-hover-primary">support@keenthemes.com</a></span>
									<!--end::Text-->
								</div>
								<!--end::Block-->
								<!--begin::Block-->
								<div class="rounded landing-dark-border p-9">
									...
									<!--end::Title-->
									<!--begin::Text-->
									<span class="fw-normal fs-4 text-gray-700">Silahkan Hubungi Nomor WhatsApp Ini
									<a href="#" class="text-white opacity-50 text-hover-primary">082267876543</a></span>
									<!--end::Text-->
								</div>
								<!--end::Block-->
								{{-- begin::modal --}}
							...
							<div class="col-lg-6 ps-lg-16">
								...
								<div class="d-flex justify-content-center">
									...
									<div class="d-flex fw-bold flex-column ms-lg-20">
										...
										<!--end::Subtitle-->
										<!--begin::Link-->
										<a href="https://id-id.facebook.com/smkwikrama1garut/" class="mb-6">
										...
										<!--end::Link-->
										<!--begin::Link-->
										<a href="https://www.instagram.com/smkwikrama1garut/?hl=en" class="mb-6">
					...
					<div class="container">
						...
						<div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
							...
							<div class="d-flex align-items-center order-2 order-md-1">
								<!--begin::Logo-->
								<a href="https://smkwikrama1garut.sch.id/">
									<img alt="Logo" src="{{ asset('source/html/theme/demo1/dist/assets/media/avatars/logos.png') }}" class="logo-default h-50px h-lg-75px" />
								</a>
								<!--end::Logo image-->
								<!--begin::Logo image-->
								<span class="mx-5 fs-6 fw-bold text-gray-600 pt-1" href="https://smkwikrama1garut.sch.id/">© 2024 SMK WIKRAMA 1 GARUT.</span>
								<!--end::Logo image-->
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
